// src/components/ComponentsDashboard/Pabrik/Monitoring/MonitoringDistributor/EditDistributorModal.jsx
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div className="bg-white p-6 rounded-lg w-full max-w-xl max-h-[90vh] overflow-y-auto">
          <h2 className="text-xl font-bold mb-4 text-center text-primary-dark">Edit Distributor</h2>

                <p className="text-sm text-gray-600 mb-4">
                    Silakan ubah data distributor pada form di bawah ini, lalu klik <strong>Simpan</strong> untuk menyimpan perubahan.
                </p>
                ...
                <div className="flex justify-end gap-2 mt-5">
                    ...
                    <button onClick={handleSubmit} className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-900">Simpan</button>
                </div>
            </div>
        </div>
    );
